...
class QueueReceiverFactory
{
    ...
    public function __invoke(ContainerInterface $container) : ReceiverInterface
    {
     ...
     */
    public static function __callStatic(string $queueName, array $arguments) : ReceiverInterface
    {
